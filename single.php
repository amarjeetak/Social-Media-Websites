...
<body>
	...
	echo "<ul>
			...
			<li><a href='my_profile.php?user_id=$user_id'>Profile</a>
				<ul>
					<li><a href='myprofile.php?user_id=$user_id'>Change Profile</a></li>
					<li><a href='changepassword.php?user_id=$user_id'>Change Password</a></li>
			...
			<li><a href='#'>Blog</a>
				<ul>
					...
					<li><a href='allfriends.php?user_id=$user_id'>Friends</a></li>
				</ul>
			</li>
